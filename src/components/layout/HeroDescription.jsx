...
const HeroDescription = () => {
  return (
    <p className="font-thin mt-4 mb-6 text-md">
      ...
      <br />
      <br />
      Join us in our passion for baking, where tradition meets innovation, and
      every cake tells a story. Discover the perfect centerpiece for your next
      celebration and let your taste buds dream a little sweeter.
    </p>
  );
};
